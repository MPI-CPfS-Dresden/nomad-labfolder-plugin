...
Can import LabFolder entries into the NOMAD ELN when provided with a mapping file
...
```sh
git clone https://github.com/MPI-CPfS-Dresden/LabFolder-Plugin.git
cd LabFolder-Plugin
...
```sh
pip install dist/LabFolder-Plugin-0.1.0
```
